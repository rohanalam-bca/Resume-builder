...
async function downloadPDF() {
  ...
  try {
    ...
    // ✅ PDF OPTIONS
    const name =
      document.getElementById('f-name').value.trim() || 'Resume';
    ...
    showToast('Saving & generating PDF...', 'success');

    // ✅ DOWNLOAD PDF
    await html2pdf().set(opt).from(el).save();

    showToast('Resume downloaded & saved to database!', 'success');
...
function fillTestData() {
  document.getElementById('f-name').value = "rohan alam";
  document.getElementById('f-email').value = "rohan@gmail.com";
  document.getElementById('f-phone').value = "9876543210";
  document.getElementById('f-profession').value = "Data Analyst";

  document.getElementById('f-summary').value =
    "Aspiring Data Analyst with strong skills in Python, SQL, and data visualization. Passionate about extracting insights from data and solving real-world business problems.";

  // Education
  document.getElementById('edu-10-board').value = "CBSE";
  document.getElementById('edu-10-year').value = "2020";
  document.getElementById('edu-10-pct').value = "85%";

  document.getElementById('edu-12-board').value = "CBSE";
  document.getElementById('edu-12-year').value = "2022";
  document.getElementById('edu-12-pct').value = "88%";

  document.getElementById('edu-deg-course').value = "BCA";
  document.getElementById('edu-deg-college').value = "Raiganj University";
  document.getElementById('edu-deg-year').value = "2026";
  document.getElementById('edu-deg-pct').value = "80%";
  ...
  [
    ...
    addSkill();
    document.querySelector('#skills-list input:last-child').value = skill;
  });
  ...
  addProject();
  document.getElementById('p1-title').value = "Sales Data Analysis Dashboard";
  document.getElementById('p1-desc').value =
    "Analyzed sales data to identify trends and improve decision-making. Created interactive dashboards and generated insights.";
  document.getElementById('p1-tech').value =
    "Python, Pandas, Excel, Power BI";

  addProject();
  document.getElementById('p2-title').value = "Customer Segmentation Analysis";
  document.getElementById('p2-desc').value =
    "Used clustering techniques to segment customers and improve targeted marketing strategies.";
  document.getElementById('p2-tech').value =
  ...
  addInternship();
  document.getElementById('i1-org').value = "ABC Analytics";
  document.getElementById('i1-role').value = "Data Analyst Intern";

  showToast("Data Analytics test data filled!", "success");
}

// function fillTestData() {
//   document.getElementById('f-name').value = "Parikshit Mandal";
//   document.getElementById('f-email').value = "test@gmail.com";
//   document.getElementById('f-phone').value = "9876543210";
//   document.getElementById('f-profession').value = "Full Stack Developer";
//   document.getElementById('f-summary').value = "Motivated developer with strong problem-solving skills.";
...
//   // Skills
//   document.querySelector('#skills-list').innerHTML = "";
//   ["JavaScript", "Python", "MySQL"].forEach(skill => {
//     addSkill();
//     document.querySelector('#skills-list input:last-child').value = skill;
//   });
...
//   projectCount = 0;
//   addProject();
//   document.getElementById('p1-title').value = "Resume Builder";
//   document.getElementById('p1-desc').value = "Web app to generate resumes";
//   document.getElementById('p1-tech').value = "HTML, CSS, JS, Flask";

//   // Internship
//   document.getElementById('internships-container').innerHTML = "";
//   internshipCount = 0;
//   addInternship();
//   document.getElementById('i1-org').value = "Tech Company";
//   document.getElementById('i1-role').value = "Web Developer";
